...
/**
 * Created by amritsingh on 6/24/2015.
 */
public class AESHelper {
     ...
     */
    public static String encrypt1(String seed, String clearText) {
     ...
     */
    public static String decrypt1(String seed, String encryptedText) {
        byte[] clearText = null;
        try {
            byte[] keyData = seed.getBytes();
            SecretKey ks = new SecretKeySpec(keyData, "AES");
